  ...
  return /******/ (function () {
    ...
    \**************************/
        /***/ function (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ PARAMETER_REGEXP: function () {
              return /* binding */ PARAMETER_REGEXP;
            },
            /* harmony export */ REPLACE_VARIABLE_REGEXP: function () {
              return /* binding */ REPLACE_VARIABLE_REGEXP;
            },
            /* harmony export */ WILDCARD_REGEXP: function () {
              return /* binding */ WILDCARD_REGEXP;
            },
            /* harmony export */ REPLACE_WILDCARD: function () {
              return /* binding */ REPLACE_WILDCARD;
            },
            /* harmony export */ NOT_SURE_REGEXP: function () {
              return /* binding */ NOT_SURE_REGEXP;
            },
            /* harmony export */ REPLACE_NOT_SURE: function () {
              return /* binding */ REPLACE_NOT_SURE;
            },
            /* harmony export */ START_BY_SLASH_REGEXP: function () {
              return /* binding */ START_BY_SLASH_REGEXP;
            },
            /* harmony export */ MATCH_REGEXP_FLAGS: function () {
              return /* binding */ MATCH_REGEXP_FLAGS;
            },
            /* harmony export */
          });
    ...
    \**********************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ Navigo;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./utils */ "./src/utils.ts");
          /* harmony import */ var _Q__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./Q */ "./src/Q.ts");
          /* harmony import */ var _middlewares_setLocationPath__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./middlewares/setLocationPath */ "./src/middlewares/setLocationPath.ts"
            );
          /* harmony import */ var _middlewares_matchPathToRegisteredRoutes__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./middlewares/matchPathToRegisteredRoutes */ "./src/middlewares/matchPathToRegisteredRoutes.ts"
            );
          /* harmony import */ var _middlewares_checkForDeprecationMethods__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./middlewares/checkForDeprecationMethods */ "./src/middlewares/checkForDeprecationMethods.ts"
            );
          /* harmony import */ var _middlewares_checkForForceOp__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./middlewares/checkForForceOp */ "./src/middlewares/checkForForceOp.ts"
            );
          /* harmony import */ var _middlewares_updateBrowserURL__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./middlewares/updateBrowserURL */ "./src/middlewares/updateBrowserURL.ts"
            );
          /* harmony import */ var _middlewares_processMatches__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./middlewares/processMatches */ "./src/middlewares/processMatches.ts"
            );
          /* harmony import */ var _middlewares_waitingList__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(
              /*! ./middlewares/waitingList */ "./src/middlewares/waitingList.ts"
            );
          /* harmony import */ var _lifecycles__WEBPACK_IMPORTED_MODULE_9__ =
          ...
          function Navigo(appRoute, options) {
            ...
            function createRoute(path, handler, hooks, name) {
              ...
              return {
                name:
                  name ||
                  (0, _utils__WEBPACK_IMPORTED_MODULE_0__.clean)(String(path)),
                path: path,
                handler: handler,
                hooks: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.accumulateHooks)(
                  hooks
                ),
              };
            } // public APIs
            ...
            function directMatchWithLocation(
              ...
              var match = (0, _utils__WEBPACK_IMPORTED_MODULE_0__.matchRoute)(
                context,
                {
                  name: String(path),
                  path: path,
    ...
    \***************************/
        /***/ function (
          ...
          __webpack_require__.r(__webpack_exports__);
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ foundLifecycle: function () {
              return /* binding */ foundLifecycle;
            },
            /* harmony export */ notFoundLifeCycle: function () {
              return /* binding */ notFoundLifeCycle;
            },
            /* harmony export */
          });
          /* harmony import */ var _Q__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./Q */ "./src/Q.ts");
          /* harmony import */ var _middlewares_checkForLeaveHook__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
          ...
          /* harmony import */ var _middlewares_callHandler__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
              /*! ./middlewares/callHandler */ "./src/middlewares/callHandler.ts"
            );
          /* harmony import */ var _middlewares_checkForAfterHook__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
              /*! ./middlewares/checkForAfterHook */ "./src/middlewares/checkForAfterHook.ts"
            );
          /* harmony import */ var _middlewares_checkForAlreadyHook__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(
              /*! ./middlewares/checkForAlreadyHook */ "./src/middlewares/checkForAlreadyHook.ts"
            );
          /* harmony import */ var _middlewares_checkForNotFoundHandler__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(
              /*! ./middlewares/checkForNotFoundHandler */ "./src/middlewares/checkForNotFoundHandler.ts"
            );
          /* harmony import */ var _middlewares_errorOut__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(
              /*! ./middlewares/errorOut */ "./src/middlewares/errorOut.ts"
            );
          /* harmony import */ var _middlewares_flushCurrent__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(
              /*! ./middlewares/flushCurrent */ "./src/middlewares/flushCurrent.ts"
            );
          /* harmony import */ var _middlewares_updateState__WEBPACK_IMPORTED_MODULE_9__ =
            __webpack_require__(
    ...
    \**********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForAfterHook;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \************************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForAlreadyHook;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \***********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForBeforeHook;
            },
            /* harmony export */
          });
          /* harmony import */ var _Q__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \*******************************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForDeprecationMethods;
            },
            /* harmony export */
          });
    ...
    \********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForForceOp;
            },
            /* harmony export */
          });
    ...
    \**********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForLeaveHook;
            },
            /* harmony export */
          });
          /* harmony import */ var _Q__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \****************************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ checkForNotFoundHandler;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \********************************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ matchPathToRegisteredRoutes;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \*******************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ processMatches;
            },
            /* harmony export */
          });
          /* harmony import */ var _Q__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ../Q */ "./src/Q.ts");
          /* harmony import */ var _lifecycles__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ../lifecycles */ "./src/lifecycles.ts");
          /* harmony import */ var _updateState__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
              /*! ./updateState */ "./src/middlewares/updateState.ts"
            );
          /* harmony import */ var _checkForLeaveHook__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
    ...
    \********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ setLocationPath;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    \*********************************************/
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ default: function () {
              return /* binding */ updateBrowserURL;
            },
            /* harmony export */
          });
          /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ =
        ...
        /***/ function (
          ...
          /* harmony export */ __webpack_require__.d(__webpack_exports__, {
            /* harmony export */ getCurrentEnvURL: function () {
              return /* binding */ getCurrentEnvURL;
            },
            /* harmony export */ clean: function () {
            ...
            /* harmony export */ extractHashFromURL: function () {
              return /* binding */ extractHashFromURL;
            },
            /* harmony export */ regExpResultToParams: function () {
              return /* binding */ regExpResultToParams;
            },
            /* harmony export */ extractGETParameters: function () {
              return /* binding */ extractGETParameters;
            },
            /* harmony export */ parseQuery: function () {
              return /* binding */ parseQuery;
            },
            /* harmony export */ matchRoute: function () {
              return /* binding */ matchRoute;
            },
            /* harmony export */ pushStateAvailable: function () {
              return /* binding */ pushStateAvailable;
            },
            /* harmony export */ undefinedOrTrue: function () {
              return /* binding */ undefinedOrTrue;
            },
            /* harmony export */ parseNavigateOptions: function () {
              return /* binding */ parseNavigateOptions;
            },
            /* harmony export */ windowAvailable: function () {
              return /* binding */ windowAvailable;
            },
            /* harmony export */ accumulateHooks: function () {
              return /* binding */ accumulateHooks;
            },
            /* harmony export */
          });
          ...
          function matchRoute(context, route) {
            ...
            if (match) {
              ...
              return {
                url: clean(
                  current.replace(new RegExp("^" + context.instance.root), "")
                ),
                queryString: GETParams,
                hashString: extractHashFromURL(context.to),
                route: route,
          ...
          function accumulateHooks(hooks, result) {
            ...
            hooks
              ...
              .forEach(function (h) {
                ["before", "after", "already", "leave"].forEach(function (
                  type
                ) {
                  if (h[type]) {
